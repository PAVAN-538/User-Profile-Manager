...
function viewUser(userId) {
  ...
  document.getElementById("altPhoneNumber").value = user.altPhoneNumber || "";
  ...
  document.getElementById("domicileState").value = user.domicileState || "";
  document.getElementById("domicileCountry").value = user.domicileCountry || "";

  // Populate education
  document.getElementById("schoolCollege").value = user.schoolCollege || "";
  document.getElementById("degree").value = user.degree || "";
  document.getElementById("course").value = user.course || "";
  document.getElementById("completionYear").value = user.completionYear || "";
...
function saveFormChanges(formId) {
  ...
  if (formId === "basicInfoForm") {
    ...
    user.domicileCountry = document.getElementById("domicileCountry").value;
